...
public class ReactomeBrowser implements EntryPoint {
	...
	public void onModuleLoad() {
	    ...
	    diagramPane = new PathwayDiagramPanel(true);
...
//	    System.out.println("Size: " + Window.getClientWidth() + ", " + Window.getClientHeight());
	...
	private void addTestHandlers() {
		...
		diagramPane.addZoomedOutEventHandler(new ZoomedOutEventHandler() {

			@Override
			public void onZoomedOut(ZoomedOutEvent event) {
				System.out.println("Less than min scale - " + event.getPathwayId());
			}
		});
	}
