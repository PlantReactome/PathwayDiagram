...
//		overView = Canvas.createIfSupported();
		...
		RequestBuilder requestBuilder = new RequestBuilder(RequestBuilder.GET,"EGFR_Simple_36.xml");
		try {
	...
	/**
	 * A JSNI method to check if a canvas plug-in is used
	 * @param element
	 * @return
	 */
    private native boolean isSupportedRunTime(CanvasElement element) /*-{
