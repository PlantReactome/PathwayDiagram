...
/**
 * Plots a rectangular Protein Node at the specified coordinates with the specific Node Height and Width
 *
 */
public class ProteinNode extends GraphNode{
	
	RenderableNode  proteinNode;
	  
	public ProteinNode(String idno, String bounds, String Position, String bgColor) {
		super(idno, bounds, Position, bgColor);
		proteinNode = new RenderableNode(cenX, cenY, coX, coY, nodeWidth, nodeHeight, strokeColor, this.bgColor);
	}

	public void draw(Context2d context){
		proteinNode.drawRectangle(context,radius);
	}
}
